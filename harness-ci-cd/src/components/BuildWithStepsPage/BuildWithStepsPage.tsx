...
const pickClassName = (
  ...
  if (status === 'running' || status === 'asyncwaiting') return classes.running;
...
export const BuildWithStepsPage = () => {
  ...
  setBuildUrl(`https://app.harness.io/ng/#/account/${entity.metadata.annotations?.['accountIdentifier']}/ci/orgs/${entity.metadata.annotations?.['orgIdentifier']}/projects/${entity.metadata.annotations?.['projectIdentifier']}/pipelines/${data.data.pipelineExecutionSummary.pipelineIdentifier}/deployments/${planExecutionId}/pipeline`);
