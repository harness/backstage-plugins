...
const RenderHealthScore = ({
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', margin: '0 8px' }}>
      ...
      <div>{getRiskLabelStringId(riskStatus)}</div>
    </div>
  );
};
...
const DropdownRow: React.FC<any> = ({
  accountId,
  orgId,
  projectId,
  monitoredServiceId,
      ...
      {currTableData.map(row => (
        <TableRow key={row.id}>
          ...
          <TableCell align="left">
            <RenderSloStatus errorBudgetRisk={row.errorBudgetRisk} />{' '}
          </TableCell>
          <TableCell align="left">
      ...
      <React.Fragment>
        <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
          <TableCell align="left">
            ...
            >
              {open ? (
                <span>{React.createElement(UpIcon)}</span>
              ) : (
                <span>{React.createElement(DownIcon)}</span>
              )}
            </button>
          </TableCell>
          <TableCell component="th" scope="row">
            <>
              ...
              >
                ...
                >
                  ...
                  <div style={{ margin: '4px 0' }}>{row.environmentRef}</div>
                </div>
              </Link>
            </>
          </TableCell>
          ...
          <TableCell align="left">
            <RenderChangeComponent row={row} />
          </TableCell>
          <TableCell align="left">
            <RenderHealthScore
              riskStatus={row.currentHealthScore.riskStatus}
              healthScore={row.currentHealthScore.healthScore}
            />
          </TableCell>
        </TableRow>
                ...
                <Table aria-label="purchases">
                  ...
                  <TableBody>
                    <DropdownRow
                      ...
                      monitoredServiceId={row.identifier}
                      baseUrl1={baseUrl1}
                      env={env}
                    />
                  </TableBody>
