  ...
  if (icon == "symbol-triangle-up") {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div>
          <svg style={iconStyle} data-icon="symbol-triangle-up" width="10" height="10" viewBox="0 0 16 16"><desc>symbol-triangle-up</desc><path d="M12.89 11.56l-3.99-8h-.01c-.17-.32-.5-.55-.89-.55s-.72.23-.89.55H7.1l-4 8h.01c-.06.14-.11.29-.11.45 0 .55.45 1 1 1h8c.55 0 1-.45 1-1 0-.16-.05-.31-.11-.45z" fillRule="evenodd"></path></svg>
        </div>
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div>
          <svg style={iconStyle} data-icon="symbol-triangle-down" width="10" height="10" viewBox="0 0 16 16"><desc>symbol-triangle-down</desc><path d="M13 4.01c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1 0 .16.05.31.11.44H3.1l4 8h.01c.16.33.49.56.89.56s.72-.23.89-.56h.01l4-8h-.01c.06-.14.11-.28.11-.44z" fillRule="evenodd"></path></svg>
        </div>
        <div style={{ color: color, fontSize: '12px' }}>{text}</div>
      </div>
    );
