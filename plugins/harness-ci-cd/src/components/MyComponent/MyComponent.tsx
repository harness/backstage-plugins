...
function PrintCard(props: any)
{
  ...
  {
    return (<><Box>
      <Grid container justifyContent="center" alignItems="flex-start" rowSpacing={2} columnSpacing={4}>
        <Grid item md={1} alignItems={'center'}>
        {row.branch=="undefined"?null:<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="25" height="25"><path fillRule="evenodd" clipRule="evenodd" d="M29 16a13.02 13.02 0 01-.854 4.6.387.387 0 01-.637.13l-3.99-3.94a.534.534 0 01-.085-.628c.432-.827.649-1.773.649-2.762.056-3.222-2.6-5.878-5.879-5.878-1.04 0-1.994.26-2.823.706a.53.53 0 01-.623-.08l-3.551-3.504a.48.48 0 01.154-.794A12.79 12.79 0 0116 3c7.178 0 13 5.822 13 13zM8.476 5.42a.582.582 0 01.746.072l4.035 4.035c.179.178.194.46.054.67a5.829 5.829 0 00-.985 3.26 5.934 5.934 0 005.935 5.934 5.829 5.829 0 003.26-.985.531.531 0 01.67.054l4.367 4.368a.582.582 0 01.065.756C24.225 26.86 20.4 29 16 29 8.822 29 3 23.178 3 16c0-4.403 2.144-8.231 5.476-10.58zm9.785 11.71a3.932 3.932 0 003.956-3.956 3.932 3.932 0 00-3.956-3.957 3.932 3.932 0 00-3.957 3.957 3.932 3.932 0 003.957 3.956z" fill="url(#ci-main_svg__a)"></path><defs><linearGradient id="ci-main_svg__a" x1="-5.398" y1="11.398" x2="11.398" y2="37.398" gradientUnits="userSpaceOnUse"><stop stopColor="#73DFE7"></stop><stop offset="1" stopColor="#0095F7"></stop></linearGradient></defs></svg>}
        </Grid>
        <Grid item md={10}>
...
function PrintBranch(props:any) {
  ...
  else if(row.targetbranch=="undefined")
  {
    ...
    <Typography style={{display:'inline',padding:'2px'}} >{row.branch}</Typography></span></div></>)
  }
  else
  {
    return(<><div><span style={{background:"#cceeff",padding:'3px'}}><svg viewBox="0 0 13 14" xmlns="http://www.w3.org/2000/svg" width="14" height="14"><path d="M12.438 2.452l-.006-.017a.367.367 0 00-.067-.114l-.004-.007L10.409.125a.374.374 0 00-.28-.125H2.327a.376.376 0 00-.28.125L.095 2.314l-.005.008a.374.374 0 00-.066.113l-.006.017a.37.37 0 00-.018.11v11.064c0 .206.168.374.374.374h11.707a.375.375 0 00.375-.374V2.563a.369.369 0 00-.018-.111zm-7.91 7.86h3.4v.357a.318.318 0 01-.318.318H4.846a.318.318 0 01-.318-.318v-.357zM.75 9.563V6.625h3.03v.357c0 .588.479 1.066 1.067 1.066H7.61c.588 0 1.066-.478 1.066-1.066v-.357h3.03v2.938H.75zm3.03-6.626v.357c0 .588.479 1.067 1.067 1.067H7.61c.589 0 1.067-.479 1.067-1.067v-.357h3.03v2.939H.75V2.937h3.03zm4.15 0v.357a.318.318 0 01-.318.318H4.846a.318.318 0 01-.318-.318v-.357h3.4zm-3.4 3.688h3.4v.357a.318.318 0 01-.319.317H4.846a.317.317 0 01-.318-.317v-.357zM2.493.749h7.468l1.284 1.44H1.21L2.494.748zm9.213 12.502H.75v-2.939h3.03v.357c0 .589.479 1.067 1.067 1.067H7.61c.588 0 1.066-.478 1.066-1.067v-.357h3.03v2.94z" fill="currentColor"></path></svg>
    ...
    <Typography style={{display:'inline',padding:'2px'}} >{row.targetbranch}</Typography></span></div></>);
  }
...
function PrintCD(props:any) {
  let row=props.props;
  return(<div style={{display:'block'}} >
  <Typography style={{display:'inline',padding:'2px'}}><b>Service Deployed: </b></Typography><Typography style={{display:'inline',padding:'2px'}} ><OverflowTooltip text={row?.cdser} /></Typography>
  <Typography style={{display:'inline',padding:'2px'}}> <b>Environments: </b></Typography><Typography style={{display:'inline',padding:'2px'}} ><OverflowTooltip text={row?.cdenv} /></Typography>
  </div>);
